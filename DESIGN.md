...
> **予定(event)は持たない。** カレンダーアプリが既にある。二重管理はADHD的に最悪。予定はGoogle Calendar等に任せ、必要ならMCP連携する。
...
3. **タイプ別タブ** — task / note / wish フィルタリング
